...
public class SignReadScreen extends Screen
{
	...
	private final String[][] signs =
	{
			...
			{ "JUMPING", "", "PRESS Z TO JUMP", "YOU CAN JUMP HIGHER BY", "GETTING A RUNNING START",
					"OR HOLDING DOWN Z", },
			...
			{ "BATTLING", "", "THE GREMLIN IS LARGE", "AND IN YOUR WAY.", "OVERHEAT IT TO DESTROY",
			...
			{ "FEEDING", "", "THE JABBERWOCKY IS", "HUNGRY, AND WILL EAT", "WAY MORE THAN IT SHOULD", "",
					"PLEASE DO NOT FEED!", },
