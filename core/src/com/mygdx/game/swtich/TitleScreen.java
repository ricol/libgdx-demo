...
public class TitleScreen implements Screen
{
	...
	public TitleScreen(Game aGame)
	{
		...
		Label title = new Label("Title Screen", MyGdxGameSwitch.gameSkin, "big-black");
		title.setAlignment(Align.center);
		title.setY(Gdx.graphics.getHeight() * 2 / 3);
		title.setWidth(Gdx.graphics.getWidth());
		stage.addActor(title);

		TextButton playButton = new TextButton("Play!", MyGdxGameSwitch.gameSkin);
		...
		TextButton optionsButton = new TextButton("Options", MyGdxGameSwitch.gameSkin);
