...
import com.mygdx.game.box2d.MyGdxGameBox2d;
...
public class MusicalNote extends Image
{
	...
	{
		super(new Texture("box2d/note.jpg"));
		this.setPosition(pos_x, pos_y);

		world = aWorld;
		effect = new ParticleEffect();
		effect.load(Gdx.files.internal("box2d/bubleNote.p"), MyGdxGameBox2d.textureAtlas);
		effect.start();
