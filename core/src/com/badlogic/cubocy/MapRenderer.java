...
public class MapRenderer
{
    ...
    {
        this.tile = new TextureRegion(new Texture(Gdx.files.internal("cuboc/data/tile.png")), 0, 0, 20, 20);
        Texture bobTexture = new Texture(Gdx.files.internal("cuboc/data/bob.png"));
