...
public class Assets
{
	...
	{
		return new Texture(Gdx.files.internal("SuperJumper/" + file));
	}
	...
	public static void load()
	{
		...
		if (Settings.soundEnabled)
			music.play();
		jumpSound = Gdx.audio.newSound(Gdx.files.internal("SuperJumper/data/jump.wav"));
		highJumpSound = Gdx.audio.newSound(Gdx.files.internal("SuperJumper/data/highjump.wav"));
		hitSound = Gdx.audio.newSound(Gdx.files.internal("SuperJumper/data/hit.wav"));
		coinSound = Gdx.audio.newSound(Gdx.files.internal("SuperJumper/data/coin.wav"));
		clickSound = Gdx.audio.newSound(Gdx.files.internal("SuperJumper/data/click.wav"));
	}
