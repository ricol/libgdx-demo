...
/**
 * This interface defines methods that draw graphical elements such as lines as
 * circles to display the field. An implementation of this interface is passed
 * to FieldElement objects so they can draw themselves without depending
