...
/**
 * This class implements the Field.Delegate interface and does nothing for each
 * of the interface methods. Real delegates can subclass this class to avoid
 * having to create empty implementations for events they don't care about. If a
 * field definition doesn't specify a delegate class, an instance of this class
 * will be used as a placeholder delegate.
 * 
 * @author brian
 */
