...
public class JSONUtils
{
	...
	/**
	 * If argument is a JSONArray or JSONObject, returns the equivalent List or Map.
	 * If argument is JSONObject.NULL, returns null. Otherwise, returns the argument
	 * unchanged.
	 */
	 ...
	 * Recursively converts nested JSONArray and JSONObject values to List and Map
	 * objects.
	 */
