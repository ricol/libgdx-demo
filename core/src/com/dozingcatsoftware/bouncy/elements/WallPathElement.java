...
/**
 * FieldElement subclass which represents a series of wall segments. The
 * segments are defined in the "positions" parameter as a list of [x,y] values,
 * for example: { "class": "WallPathElement", "positions": [[5,5], [5,10],
 * [8,10], [5, 15]] }
 * 
 * @author brian
 */
