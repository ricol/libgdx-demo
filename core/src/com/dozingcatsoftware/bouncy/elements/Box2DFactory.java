...
public class Box2DFactory
{
	...
	/**
	 * Creates a wall by constructing a rectangle whose corners are (xmin,ymin) and
	 * (xmax,ymax), and rotating the box counterclockwise through the given angle.
	...
	/**
	 * Creates a segment-like thin wall with 0.05 thickness going from (x1,y1) to
	 * (x2,y2)
	 */
