...
/**
 * This FieldElement subclass approximates a circular wall with a series of
 * straight wall segments whose endpoints lie on a circle or ellipse. These
 * elements are defined in the layout JSON as follows: { "class":
 * "WallArcElement", "center": [5.5, 10], // center of circle or ellipse
 * "xradius": 2.5, // radius in the horizontal direction "yradius": 2, // radius
 * in the y direction "minangle": 45, // starting angle in degrees, 0 is to the
 * right of the center, 90 is up. "maxangle": 135, // ending angle in degrees
 * "segments": 10, // number of straight wall segments to use to approximate the
 * arc. "color": [255,0,0] // optional RGB values for the arc's color }
 * 
 * For circular walls, the "radius" attribute can be used instead of xradius and
 * yradius.
 * 
 * @author brian
 */
