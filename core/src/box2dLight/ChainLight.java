...
public class ChainLight extends Light
{
    ...
    public ChainLight(RayHandler rayHandler, int rays, Color color, float distance, int rayDirection, float[] chain)
    {
        ...
        lightMesh = new Mesh(VertexDataType.VertexArray, false, vertexNum, 0,
            ...
            new VertexAttribute(Usage.ColorPacked, 4, "quad_colors"), new VertexAttribute(Usage.Generic, 1, "s"));
    ...
    /**
     * Calculates ray positions and angles along chain. This should be called any time the number or values of elements changes in {@link #chain}.
     */
    ...
    protected boolean cull()
    {
        ...
        {
            updateBoundingRects();
            culled = chainLightBounds.width > 0 && chainLightBounds.height > 0
    ...
    protected void updateBoundingRects()
    {
        ...
        rayHandlerBounds.set(rayHandler.x1, rayHandler.y1, rayHandler.x2 - rayHandler.x1,
