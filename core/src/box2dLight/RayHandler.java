...
public class RayHandler implements Disposable
{
    ...
    /**
     * Gamma correction value used if enabled TODO: remove final modifier and provide method to change this default value if needed to anyone?
     */
    ...
    /**
     * Class constructor specifying the physics world from where collision geometry is taken, and size of FBO used for intermediate rendering.
     *
    ...
    {
        this.setCombinedMatrix(camera.combined, camera.position.x, camera.position.y,
     ...
     *
     * @deprecated use {@link #setCombinedMatrix(OrthographicCamera)} or {@link #setCombinedMatrix(Matrix4, float, float, float, float)} instead
     */
    @Deprecated
     ...
     * @param viewPortWidth NOTE!! use actual size, remember to multiple with zoom value if pulled from OrthoCamera
     * @param viewPortHeight NOTE!! use actual size, remember to multiple with zoom value if pulled from OrthoCamera
     *
     ...
     *
     * @return true if camera screen intersects or contains provided light, represented by circle/box area
     */
     ...
     *
     * <p>
     * Don't call this inside of any begin/end statements. Call this method after you have rendered background but before UI. Box2d bodies can be rendered before or after depending how you want the x-ray lights to interact with them.
     *
     * @see #update()
     * @see #render()
     */
     ...
     *
     * <p>
     * You should need to use this method only if you want to render lights on a frame buffer object. Use {@link #render()} otherwise.
     *
     * <p>
     ...
     *
     * <p>
     * <b>NOTE!</b> Remember to set combined matrix and update lights before using this method manually.
     *
     * <p>
     * Don't call this inside of any begin/end statements. Call this method after you have rendered background but before UI. Box2d bodies can be rendered before or after depending how you want the x-ray lights to interact with them.
     *
     ...
     *
     * <p>
     * Use this method if you want to render lights in a frame buffer object. You must call {@link #prepareRender()} before calling this method. Also, {@link #prepareRender()} must not be inside of any begin/end statements
     *
     * @see #prepareRender()
     */
     ...
     * Default = Color(0, 0, 0, 0)
     *
     * @param ambientLightColor color whose RGB components specify the shadows coloring and alpha specify shadows brightness
     *
     * @see #setAmbientLight(float)
     * @see #setAmbientLight(float, float, float, float)
     */
     ...
     *
     * <p>
     * NOTE: To match the visuals with gamma uncorrected lights the light distance parameters is modified implicitly.
     */
     ...
     *
     * <p>
     * If set to true lights are blended using the diffuse shader. This is more realistic model than normally used as it preserve colors but might look bit darker and also it might improve performance slightly.
     */
     ...
     * <p>
     * Note: you will be responsible for update of viewport via this method in case of any changes (on resize)
     */
     ...
     *
     * @return Texture that contain lightmap texture that can be used as light texture in your shaders
     */
