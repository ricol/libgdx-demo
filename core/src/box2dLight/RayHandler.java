...
public class RayHandler implements Disposable
{
	...
	/**
	 * if this is public why we have a setter? TODO: remove public modifier and add
	 * getter
	 */
	...
	/**
	 * Class constructor specifying the physics world from where collision geometry
	 * is taken.
	 * 
	 * <p>
	...
	/**
	 * Class constructor specifying the physics world from where collision geometry
	 * is taken, and size of FBO used for intermediate rendering.
	 * 
	 ...
	 * 
	 * <p>
	 * Matrix must be set to work in box2d coordinates, it will be copied and used
	 * for culling and rendering. Remember to update it if camera changes. This will
	 * work with rotated cameras.
	 * 
	 * <p>
	 ...
	 *             {@link #setCombinedMatrix(Matrix4, float, float, float, float)}
	 *             instead
	 */
	@Deprecated
	 ...
	 * @param viewPortWidth  NOTE!! use actual size, remember to multiple with zoom
	 *                       value if pulled from OrthoCamera
	 * @param viewPortHeight NOTE!! use actual size, remember to multiple with zoom
	 *                       value if pulled from OrthoCamera
	 * 
	 ...
	 * 
	 * @return true if camera screen intersects or contains provided light,
	 *         represented by circle/box area
	 */
	 ...
	 * 
	 * <p>
	 * Don't call this inside of any begin/end statements. Call this method after
	 * you have rendered background but before UI. Box2d bodies can be rendered
	 * before or after depending how you want the x-ray lights to interact with
	 * them.
	 * 
	 * @see #update()
	 * @see #render()
	 ...
	 *
	 * <p>
	 * You should need to use this method only if you want to render lights on a
	 * frame buffer object. Use {@link #render()} otherwise.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <b>NOTE!</b> Remember to set combined matrix and update lights before using
	...
	/**
	 * Manual rendering method for all lights tha can be used inside of begin/end
	 * statements
	 *
	 * <p>
	 * Use this method if you want to render lights in a frame buffer object. You
	 * must call {@link #prepareRender()} before calling this method. Also,
	 ...
	 * 
	 * <p>
	 * This make lights much more softer and realistic look but cost some precious
	 * shader time. With default FBO size on android cost around 1ms.
	 * 
	 * <p>
	 * Default = true
	 * 
	 ...
	 * 
	 * <p>
	 * Blurring can be pretty heavy weight operation, 1-3 should be safe. Setting
	 * this to 0 is the same as disabling it.
	 * 
	 * <p>
	 * Default = 1
	 * 
	 ...
	 * 
	 * <p>
	 * NOTE: To match the visuals with gamma uncorrected lights the light distance
	 * parameters is modified implicitly.
	 */
	 ...
	 * realistic model than normally used as it preserve colors but might look bit
	 * darker and also it might improve performance slightly.
	 */
	 ...
	 * <p>
	 * Note: you will be responsible for update of viewport via this method in case
	 * of any changes (on resize)
	 */
