...
public class ConeLight extends PositionalLight
{
	...
	/**
	 * Creates light shaped as a circle's sector with given radius, direction and
	 * arc angle
	 * 
	 ...
	 * @param distance        distance of cone light, soft shadow length is set to
	 *                        distance * 0.1f
	 ...
	 */
	public ConeLight(RayHandler rayHandler, int rays, Color color, float distance, float x, float y,
