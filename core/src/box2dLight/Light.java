...
/**
 * Light is data container for all the light parameters. When created lights are automatically added to rayHandler and could be removed by calling {@link #remove()} and added manually by calling {@link #add(RayHandler)}.
 *
 * <p>
...
public abstract class Light implements Disposable
{
    ...
    /**
     * Creates new active light and automatically adds it to the specified {@link RayHandler} instance.
     *
     ...
     *
     * @param body that will be automatically followed, note that the body rotation angle is taken into account for the light offset and direction calculations
     */
     ...
     *
     * @param flag - if {@code true} all the fixtures of attached body will be ignored and will not create any shadows for this light. By default is set to {@code false}.
     */
