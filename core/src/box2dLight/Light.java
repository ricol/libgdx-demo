...
public abstract class Light implements Disposable
{
	 ...
	 * @param rays            number of rays - more rays make light to look more
	 *                        realistic but will decrease performance, can't be less
	 *                        than MIN_RAYS
	 * @param color           light color
	 * @param distance        light distance (if applicable), soft shadow length is
	 *                        set to distance * 0.1f
	 ...
	 * 
	 * @param body that will be automatically followed, note that the body rotation
	 *             angle is taken into account for the light offset and direction
	 *             calculations
	 */
	 ...
	 * 
	 * <p>
	 * Enabling this will allow beams go through obstacles that reduce CPU burden of
	 * light about 70%.
	 * 
	 * <p>
	 ...
	 *         parameters will update it. Static lights are useful for lights that
	 *         you want to collide with static geometry but ignore all the dynamic
	 *         objects.
	 */
	 ...
	 * 
	 * <p>
	 * Static light do not get any automatic updates but setting any parameters will
	 * update it. Static lights are useful for lights that you want to collide with
	 * static geometry but ignore all the dynamic objects
	 * 
	 * <p>
	 ...
	 * 
	 * @param flag - if {@code true} all the fixtures of attached body will be
